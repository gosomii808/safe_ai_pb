export const eventSeeds = [
  {
    ...
    importance: 'HIGH',
    description:
      '연준 기준금리와 점도표 발표. 기자회견 톤이 단기 위험자산 변동성에 영향을 줄 수 있습니다.',
  ...
  },
  {
    ...
    importance: 'HIGH',
    description:
      '소비자물가 추세 확인 이벤트로 금리 기대 경로의 재조정 가능성이 있습니다.',
  ...
  },
  {
    ...
    importance: 'MEDIUM',
    description:
      '정책금리와 통화정책 방향성 코멘트가 원화 및 국내 성장주 심리에 영향을 줄 수 있습니다.',
...
export const ruleSeeds = [
  {
    ...
    explanation:
      '할인율 상승 구간에서는 성장주 밸류에이션 부담이 커질 수 있습니다.',
    riskLevel: 'MEDIUM',
  },
  {
    ...
    explanation:
      '물가 상방은 장기채 금리 상승 압력으로 채권 가격의 단기 약세 가능성을 높입니다.',
    riskLevel: 'MEDIUM',
  },
  {
