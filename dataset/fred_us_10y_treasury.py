# dataset/fetch_fred_us_10y_treasury_rate.py
...
# =========================
# 3. 수집 대상: 미국 10년물 국채금리
# =========================
# DGS10:
# 10-Year Treasury Constant Maturity Rate
#
# 미국 장기금리를 대표하는 지표.
# 나스닥, 성장주, 채권, 환율 영향 분석에 사용.

SERIES_ID = "DGS10"
DATA_NAME = "미국_10년물_국채금리"
ITEM_NAME = "10-Year Treasury Constant Maturity Rate"
KOREAN_NAME = "미국 10년물 국채금리"
UNIT = "percent"
FREQUENCY = "daily"
DESCRIPTION = "미국 장기금리 대표 지표. 나스닥, 성장주, 채권, 환율 영향 분석에 사용."
...
def fetch_us_10y_treasury_rate(
    start_date: str = START_DATE,
    end_date: str = END_DATE,
) -> pd.DataFrame:
    """
    FRED API에서 미국 10년물 국채금리(DGS10)를 수집한다.
    """
...
def main():
    try:
        df = fetch_us_10y_treasury_rate()
        save_csv(df)

        print("\n[PREVIEW]")
        print(df.tail())

        print("\n[DONE] 미국 10년물 국채금리 데이터 수집 완료")

    except Exception as e:
        print("[ERROR] 미국 10년물 국채금리 수집 실패")
        print(f"[ERROR] 사유: {e}")
        ...
        failed_log_path = os.path.join(
            LOG_DIR,
            "fred_us_10y_treasury_rate_failed_logs.csv"
        )
